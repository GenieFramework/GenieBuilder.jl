...
const blockDefinitions = [
  {
      type: "partial", label: "Partial", tagName: "PARTIAL", 
      content: `<partial>PARTIAL C</partial>`, 
      renderContent: `<div>PARTIAL</div>`, 
      ...
      properties: [
            {
              ...
              "name": "path",
              "type": "String",
              "desc": "Path to the file containing the partial",
              "options": []
          },
      ]
    }, 
    {
        type: "q-slider", label: "Slider", tagName: "Q-SLIDER", 
        category: "controls", 
        content: `<q-slider gb_c__min="0" gb_c__max="100" gb_b__v-model=""></q-slider>`, 
        renderContent: `<div class="q-slider q-slider--h q-slider--inactive inline no-wrap column q-slider--enabled q-slider--editable" role="slider" aria-valuemin="0" aria-valuemax="50" aria-orientation="horizontal" data-step="1" aria-valuenow="2"><div class="q-slider__track-container q-slider__track-container--h" tabindex="0"><div class="q-slider__track relative-position no-outline" style="height: 4px;"><div class="q-slider__inner absolute" style="left: 0%; width: 100%;"></div><div class="q-slider__selection absolute" style="left: 0%; width: 4%;"></div><div class="q-slider__thumb q-slider__thumb--h q-slider__thumb--h-ltr absolute non-selectable" style="width: 20px; height: 20px; left: 4%;"><svg class="q-slider__thumb-shape absolute-full" viewBox="0 0 20 20" aria-hidden="true"><path d="M 4, 10 a 6,6 0 1,0 12,0 a 6,6 0 1,0 -12,0"></path></svg><div class="q-slider__focus-ring fit"></div></div></div></div></div>`, 
        droppable: false,     editable: false,     draggable: true,
        properties: [
            {
                "label": "Data Binding",
    ...
    {
        type: "q-select", label: "Select", tagName: "Q-SELECT", 
        category: "controls", 
        content: `<q-select gb_b__v-model="" gb_c__options="['Option 1', 'Option 2', 'Option 3']"></q-select>`, 
        renderContent: `<label class="q-field row no-wrap items-start q-field--standard q-select q-field--auto-height q-select--without-input q-select--without-chips q-select--single q-field--labeled" for="f_a2492a46-9115-4887-9273-e5dcd02b6ba4"><!----><div class="q-field__inner relative-position col self-stretch"><div class="q-field__control relative-position row no-wrap" tabindex="-1"><div class="q-field__control-container col relative-position row no-wrap q-anchor--skip"><div class="q-field__native row items-center"><span></span><input class="q-select__focus-target" id="f_a2492a46-9115-4887-9273-e5dcd02b6ba4" readonly="" tabindex="0" role="combobox" aria-label="Select" aria-readonly="false" aria-autocomplete="none" aria-expanded="false" aria-controls="f_a2492a46-9115-4887-9273-e5dcd02b6ba4_lb"></div><div class="q-field__label no-pointer-events absolute ellipsis">Select</div><!----></div><div class="q-field__append q-field__marginal row no-wrap items-center q-anchor--skip"><span class="q-icon q-select__dropdown-icon" aria-hidden="true" role="presentation"><svg viewBox="0 0 24 24"><path d="M7,10L12,15L17,10H7Z"></path></svg></span></div><!----></div><!----></div><!----></label>`, 
        droppable: false,     editable: false,     draggable: true,
        properties: [
            {
                "label": "Data Binding",
...

    {
        ...
        tagName: "Q-SEPARATOR",
        category: "content", 
        content: `<q-separator><div>q-separator</div></q-separator>`,
        renderContent: `<hr class="q-separator q-separator--horizontal" aria-orientation="horizontal">`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "dark",
    ...
    
      {
        ...
        tagName: "Q-SPACE",
        category: "content", 
        content: `<q-space><div>q-space</div></q-space>`,
        renderContent: `<div class="q-space"></div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [],
      },
    
      {
        ...
        tagName: "Q-TOOLBAR",
        category: "content", 
        content: `<q-toolbar><div>q-toolbar</div></q-toolbar>`,
        renderContent: `<div class="q-toolbar row no-wrap items-center text-primary" role="toolbar"><button class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--round q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" type="button"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row"><i class="q-icon notranslate material-icons" aria-hidden="true" role="img">menu</i></span></button><div class="q-toolbar__title ellipsis"> Toolbar </div><button class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--round q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" type="button"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row"><i class="q-icon notranslate material-icons" aria-hidden="true" role="img">more_vert</i></span></button></div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "inset",
    ...
    
      {
        ...
        tagName: "Q-INPUT",
        category: "controls", 
        content: `<q-input gb_b__v-model="" gb_c__label="Input"></q-input>`,
        renderContent: `<label class="q-field row no-wrap items-start q-field--standard q-input q-field--labeled" style="pointer-events: none;" for="f_5659f165-b62f-4ee7-92fa-308cdfb4be4e"><!----><div class="q-field__inner relative-position col self-stretch"><div class="q-field__control relative-position row no-wrap" tabindex="-1"><div class="q-field__control-container col relative-position row no-wrap q-anchor--skip"><input class="q-field__native q-placeholder" tabindex="0" aria-label="Standard" id="f_5659f165-b62f-4ee7-92fa-308cdfb4be4e" type="text"><div class="q-field__label no-pointer-events absolute ellipsis">Standard</div><!----></div></div><!----></div><!----></label>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
          ...
          },
          {
            ...
            desc: "Use 'standout' design for the field; Specifies classes to be applied when focused (overriding default ones)",
            category: "style",
            examples: ["standout", 'standout="bg-primary text-white"'],
            enabled: true,
          },
          {
            label: "label-slot",
    ...
    
      {
        ...
        tagName: "Q-BTN",
        category: "controls", 
        content: `<q-btn gb_c__label="Button"></q-btn>`,
        renderContent: `<button class="q-btn q-btn-item non-selectable no-outline q-btn--standard q-btn--rectangle bg-white text-black q-btn--actionable q-focusable q-hoverable" tabindex="0" type="button"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row"><span class="block">Button</span></span></button>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "On-click",
          ...
          },
          {
            ...
            category: "navigation",
            examples: ["/home/dashboard", ":to=\"{ name: 'my-route-name' }\""],
            enabled: true,
          },
          {
            label: "replace",
    ...
    
      {
        ...
        tagName: "Q-RADIO",
        category: "controls", 
        content: `<q-radio gb_b__v-model="" gb_c__val="My Value" gb_c__label="Radio"></q-radio>`,
        renderContent: `<div class="q-radio cursor-pointer no-outline row inline no-wrap items-center" tabindex="0" role="radio" aria-label="Radio" aria-checked="true"><div class="q-radio__inner relative-position q-radio__inner--truthy" aria-hidden="true"><input class="hidden q-radio__native q-ma-none q-pa-none" type="radio"><svg class="q-radio__bg absolute non-selectable" viewBox="0 0 24 24"><path d="M12,22a10,10 0 0 1 -10,-10a10,10 0 0 1 10,-10a10,10 0 0 1 10,10a10,10 0 0 1 -10,10m0,-22a12,12 0 0 0 -12,12a12,12 0 0 0 12,12a12,12 0 0 0 12,-12a12,12 0 0 0 -12,-12"></path><path class="q-radio__check" d="M12,6a6,6 0 0 0 -6,6a6,6 0 0 0 6,6a6,6 0 0 0 6,-6a6,6 0 0 0 -6,-6"></path></svg></div><span class="no-outline" tabindex="-1"></span><div class="q-radio__label q-anchor--skip">Radio</div></div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        ...
        tagName: "Q-CHECKBOX",
        category: "controls", 
        content: `<q-checkbox gb_b__v-model="" gb_c__label="Checkbox" />`,
        renderContent: `<div class="q-checkbox cursor-pointer no-outline row inline no-wrap items-center" tabindex="0" role="checkbox" aria-checked="true"><div class="q-checkbox__inner relative-position non-selectable q-checkbox__inner--truthy" aria-hidden="true"><input class="hidden q-checkbox__native absolute q-ma-none q-pa-none" type="checkbox"><div class="q-checkbox__bg absolute"><svg class="q-checkbox__svg fit absolute-full" viewBox="0 0 24 24"><path class="q-checkbox__truthy" fill="none" d="M1.73,12.91 8.1,19.28 22.79,4.59"></path><path class="q-checkbox__indet" d="M4,14H20V10H4"></path></svg></div></div><span class="no-outline" tabindex="-1"></span></div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        ...
        tagName: "Q-RANGE",
        category: "controls", 
        content: `<q-range gb_b__v-model="" gb_c__min="0" gb_c__max="100"></q-range>`,
        renderContent: `<div class="q-range q-slider q-slider--h q-slider--inactive inline no-wrap column q-slider--enabled q-slider--editable" role="slider" aria-valuemin="0" aria-valuemax="50" aria-orientation="horizontal" data-step="1" aria-valuenow="10|35"><div class="q-slider__track-container q-slider__track-container--h"><div class="q-slider__track relative-position no-outline" style="height: 4px;"><div class="q-slider__inner absolute" style="left: 0%; width: 100%;"></div><div class="q-slider__selection absolute" style="left: 20%; width: 50%;"></div><div class="q-slider__thumb q-slider__thumb--h q-slider__thumb--h-ltr absolute non-selectable" tabindex="0" style="width: 20px; height: 20px; left: 20%;"><svg class="q-slider__thumb-shape absolute-full" viewBox="0 0 20 20" aria-hidden="true"><path d="M 4, 10 a 6,6 0 1,0 12,0 a 6,6 0 1,0 -12,0"></path></svg><div class="q-slider__focus-ring fit"></div></div><div class="q-slider__thumb q-slider__thumb--h q-slider__thumb--h-ltr absolute non-selectable" tabindex="0" style="width: 20px; height: 20px; left: 70%;"><svg class="q-slider__thumb-shape absolute-full" viewBox="0 0 20 20" aria-hidden="true"><path d="M 4, 10 a 6,6 0 1,0 12,0 a 6,6 0 1,0 -12,0"></path></svg><div class="q-slider__focus-ring fit"></div></div></div></div></div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
      ...
      /* {
        ...
        content: `<q-datePicker><div>q-datePicker</div></q-datePicker>`,
        renderContent: `<div>q-datePicker</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        type: "q-timePicker",
        label: "TimePicker",
        tagName: "Q-TIMEPICKER",
        content: `<q-timePicker><div>q-timePicker</div></q-timePicker>`,
        renderContent: `<div>q-timePicker</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
          ...
          },
          {
            ...
            category: "behavior",
            examples: [':options="(hr, min, sec) => hr <= 6"'],
            enabled: true,
          },
          {
            label: "hour-options",
          ...
          },
          {
            ...
            category: "behavior",
            examples: [':minute-options="[0, 15, 30, 45]"'],
            enabled: true,
          },
          {
            ...
            category: "behavior",
            examples: [':second-options="[0, 7, 10, 23]"'],
            enabled: true,
          },
          {
            label: "with-seconds",
    ...
    
      {
        ...
        tagName: "Q-EDITOR",
        category: "controls", 
        content: `<q-editor gb_b__v-model="" gb_c__min-height="5rem"></q-editor>`,
        renderContent: `<div class="q-editor q-editor--default style="pointer-events:none;"><div class="q-editor__toolbars-container"><div class="q-editor__toolbar row no-wrap scroll-x"><div class="q-editor__toolbar-group"><a class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" role="button" style="font-size: 10px;"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row no-wrap text-no-wrap"><span class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M3,3H21V5H3V3M3,7H15V9H3V7M3,11H21V13H3V11M3,15H15V17H3V15M3,19H21V21H3V19Z"></path></svg></span><!----></span></a><a class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" role="button" style="font-size: 10px;"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row no-wrap text-no-wrap"><span class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M3,3H21V5H3V3M7,7H17V9H7V7M3,11H21V13H3V11M7,15H17V17H7V15M3,19H21V21H3V19Z"></path></svg></span><!----></span></a><a class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" role="button" style="font-size: 10px;"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row no-wrap text-no-wrap"><span class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M3,3H21V5H3V3M9,7H21V9H9V7M3,11H21V13H3V11M9,15H21V17H9V15M3,19H21V21H3V19Z"></path></svg></span><!----></span></a><a class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" role="button" style="font-size: 10px;"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row no-wrap text-no-wrap"><span class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M3,3H21V5H3V3M3,7H21V9H3V7M3,11H21V13H3V11M3,15H21V17H3V15M3,19H21V21H3V19Z"></path></svg></span><!----></span></a></div><div class="q-editor__toolbar-group"><a class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" role="button" style="font-size: 10px;"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row no-wrap text-no-wrap"><span class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M13.5,15.5H10V12.5H13.5A1.5,1.5 0 0,1 15,14A1.5,1.5 0 0,1 13.5,15.5M10,6.5H13A1.5,1.5 0 0,1 14.5,8A1.5,1.5 0 0,1 13,9.5H10M15.6,10.79C16.57,10.11 17.25,9 17.25,8C17.25,5.74 15.5,4 13.25,4H7V18H14.04C16.14,18 17.75,16.3 17.75,14.21C17.75,12.69 16.89,11.39 15.6,10.79Z"></path></svg></span><!----></span></a><a class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" role="button" style="font-size: 10px;"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row no-wrap text-no-wrap"><span class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M10,4V7H12.21L8.79,15H6V18H14V15H11.79L15.21,7H18V4H10Z"></path></svg></span><!----></span></a><a class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" role="button" style="font-size: 10px;"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row no-wrap text-no-wrap"><span class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M5,21H19V19H5V21M12,17A6,6 0 0,0 18,11V3H15.5V11A3.5,3.5 0 0,1 12,14.5A3.5,3.5 0 0,1 8.5,11V3H6V11A6,6 0 0,0 12,17Z"></path></svg></span><!----></span></a><a class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" role="button" style="font-size: 10px;"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row no-wrap text-no-wrap"><span class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M23,12V14H18.61C19.61,16.14 19.56,22 12.38,22C4.05,22.05 4.37,15.5 4.37,15.5L8.34,15.55C8.37,18.92 11.5,18.92 12.12,18.88C12.76,18.83 15.15,18.84 15.34,16.5C15.42,15.41 14.32,14.58 13.12,14H1V12H23M19.41,7.89L15.43,7.86C15.43,7.86 15.6,5.09 12.15,5.08C8.7,5.06 9,7.28 9,7.56C9.04,7.84 9.34,9.22 12,9.88H5.71C5.71,9.88 2.22,3.15 10.74,2C19.45,0.8 19.43,7.91 19.41,7.89Z"></path></svg></span><!----></span></a></div><div class="q-editor__toolbar-group"><a class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" role="button" style="font-size: 10px;"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row no-wrap text-no-wrap"><span class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M12.5,8C9.85,8 7.45,9 5.6,10.6L2,7V16H11L7.38,12.38C8.77,11.22 10.54,10.5 12.5,10.5C16.04,10.5 19.05,12.81 20.1,16L22.47,15.22C21.08,11.03 17.15,8 12.5,8Z"></path></svg></span><!----></span></a><a class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--rectangle q-btn--actionable q-focusable q-hoverable q-btn--dense" tabindex="0" role="button" style="font-size: 10px;"><span class="q-focus-helper"></span><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row no-wrap text-no-wrap"><span class="q-icon" aria-hidden="true" role="img"><svg viewBox="0 0 24 24"><path d="M18.4,10.6C16.55,9 14.15,8 11.5,8C6.85,8 2.92,11.03 1.54,15.22L3.9,16C4.95,12.81 7.95,10.5 11.5,10.5C13.45,10.5 15.23,11.22 16.62,12.38L13,16H22V7L18.4,10.6Z"></path></svg></span><!----></span></a></div></div></div><div class="q-editor__content" contenteditable="true" style="min-height: 5rem;">What you see is <b>what</b> you ddget.</div></div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        ...
        tagName: "Q-KNOB",
        category: "controls", 
        content: `<q-knob gb_c__show-value="true" gb_c__v-model="value" gb_c__size="50px" gb_c__color="light-blue"><q-knob>`,
        renderContent: `<div><div class="q-circular-progress q-circular-progress--determinate q-knob non-selectable q-knob--editable q-ma-md" role="slider" aria-valuemin="0" aria-valuemax="100" aria-valuenow="67" tabindex="0" style="font-size: 50px;"><svg class="q-circular-progress__svg" viewBox="55.55555555555556 55.55555555555556 111.11111111111111 111.11111111111111" aria-hidden="true" style="transform: rotate3d(0, 0, 1, -90deg);"><circle class="q-circular-progress__circle text-orange" fill="transparent" stroke="currentColor" stroke-width="11.111111111111112" stroke-dasharray="314.159" stroke-dashoffset="103.67255756846316" cx="111.11111111111111" cy="111.11111111111111" r="50" style="transition: stroke-dashoffset 600ms ease 0s, stroke 600ms ease 0s;"></circle></svg></div></div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
      ...
      /* {
        ...
        label: "List",
        tagName: "Q-LIST",
        content: `<q-list><div>q-list</div></q-list>`,
        renderContent: `<div>q-list</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        ...
        label: "Item",
        tagName: "Q-ITEM",
        content: `<q-item><div>q-item</div></q-item>`,
        renderContent: `<div>q-item</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        type: "q-item_label",
        label: "Item_label",
        tagName: "Q-ITEM_LABEL",
        content: `<q-item_label><div>q-item_label</div></q-item_label>`,
        renderContent: `<div>q-item_label</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        ...
        label: "DataTable",
        tagName: "Q-DATATABLE",
        content: `<q-dataTable><div>q-dataTable</div></q-dataTable>`,
        renderContent: `<div>q-dataTable</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        ...
        label: "Tab",
        tagName: "Q-TAB",
        content: `<q-tab><div>q-tab</div></q-tab>`,
        renderContent: `<div>q-tab</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "icon",
    ...
    
      {
        ...
        label: "Tabgroup",
        tagName: "Q-TABGROUP",
        content: `<q-tabgroup><div>q-tabgroup</div></q-tabgroup>`,
        renderContent: `<div>q-tabgroup</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        ...
        label: "Tabpanel",
        tagName: "Q-TABPANEL",
        content: `<q-tabpanel><div>q-tabpanel</div></q-tabpanel>`,
        renderContent: `<div>q-tabpanel</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "name",
      ...
      {
        type: "q-tabpanelgroup",
        label: "Tabpanelgroup",
        tagName: "Q-TABPANELGROUP",
        content: `<q-tabpanelgroup><div>q-tabpanelgroup</div></q-tabpanelgroup>`,
        renderContent: `<div>q-tabpanelgroup</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
          ...
          },
          {
            ...
            type: "String",
            desc: "One of Quasar's embedded transitions (has effect only if 'animated' prop is set)",
            examples: ["fade", "slide-left", "slide-right", "slide-up"],
            category: "behavior",
            enabled: true,
          },
          {
    ...
    
      {
        ...
        label: "Img",
        tagName: "Q-IMG",
        content: `<q-img><div>q-img</div></q-img>`,
        renderContent: `<div>q-img</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "ratio",
    ...
    
      {
        ...
        label: "Video",
        tagName: "Q-VIDEO",
        content: `<q-video><div>q-video</div></q-video>`,
        renderContent: `<div>q-video</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "ratio",
            ...
            category: "style",
            examples: [':ratio="4/3"', ':ratio="16/9"', 'ratio="1"'],
            enabled: true,
          },
          {
            label: "src",
    ...
    
      {
        ...
        label: "Avatar",
        tagName: "Q-AVATAR",
        content: `<q-avatar><div>q-avatar</div></q-avatar>`,
        renderContent: `<div>q-avatar</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "size",
    ...
    
      {
        ...
        label: "Badge",
        tagName: "Q-BADGE",
        content: `<q-badge><div>q-badge</div></q-badge>`,
        renderContent: `<div>q-badge</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "color",
    ...
    
      {
        ...
        label: "Banner",
        tagName: "Q-BANNER",
        content: `<q-banner><div>q-banner</div></q-banner>`,
        renderContent: `<div>q-banner</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
    ...
    
      {
        ...
        label: "Card",
        tagName: "Q-CARD",
        content: `<q-card><div>q-card</div></q-card>`,
        renderContent: `<div>q-card</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        type: "q-cardsection",
        label: "Cardsection",
        tagName: "Q-CARDSECTION",
        content: `<q-cardsection><div>q-cardsection</div></q-cardsection>`,
        renderContent: `<div>q-cardsection</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        ...
        label: "Chip",
        tagName: "Q-CHIP",
        content: `<q-chip><div>q-chip</div></q-chip>`,
        renderContent: `<div>q-chip</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        ...
        label: "Icon",
        tagName: "Q-ICON",
        content: `<q-icon><div>q-icon</div></q-icon>`,
        renderContent: `<div>q-icon</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        ...
        label: "Rating",
        tagName: "Q-RATING",
        content: `<q-rating><div>q-rating</div></q-rating>`,
        renderContent: `<div>q-rating</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        ...
        label: "Spinner",
        tagName: "Q-SPINNER",
        content: `<q-spinner><div>q-spinner</div></q-spinner>`,
        renderContent: `<div>q-spinner</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "size",
    ...
    
      {
        ...
        label: "Tree",
        tagName: "Q-TREE",
        content: `<q-tree><div>q-tree</div></q-tree>`,
        renderContent: `<div>q-tree</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "nodes",
    ...
    
      {
        type: "q-popup_proxy",
        label: "Popup_proxy",
        tagName: "Q-POPUP_PROXY",
        content: `<q-popup_proxy><div>q-popup_proxy</div></q-popup_proxy>`,
        renderContent: `<div>q-popup_proxy</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
    ...
    
      {
        ...
        label: "Timeline",
        tagName: "Q-TIMELINE",
        content: `<q-timeline><div>q-timeline</div></q-timeline>`,
        renderContent: `<div>q-timeline</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "color",
      ...
      {
        type: "q-timeline_entry",
        label: "Timeline_entry",
        tagName: "Q-TIMELINE_ENTRY",
        content: `<q-timeline_entry><div>q-timeline_entry</div></q-timeline_entry>`,
        renderContent: `<div>q-timeline_entry</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "heading",
      ...
      {
        type: "q-expansion_item",
        label: "Expansion_item",
        tagName: "Q-EXPANSION_ITEM",
        content: `<q-expansion_item><div>q-expansion_item</div></q-expansion_item>`,
        renderContent: `<div>q-expansion_item</div>`,
        droppable: false,     editable: false,     draggable: true,
        properties: [
          {
            label: "Data Binding",
   ...
   /*  {
        type: "div", label: "DIV", tagName: "DIV", 
        content: `<div style="display: block; padding: 20px;"><div>`, 
        
        droppable: true,     editable: true,     draggable: true,
        properties: [
          ], 
    },  */
    ...
    /* 
    {
        type: "q-table", label: "Data Table", tagName: "Q-TABLE", 
        //category: "controls", 
        content: `<q-table></q-table>`, 
        renderContent: `<div class="q-table__container q-table--horizontal-separator column no-wrap q-table__card q-table--no-wrap"><div class="q-table__middle scroll"><table class="q-table"><thead><tr><th class="text-left sortable">CRIM<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">ZN<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">INDUS<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">CHAS<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">NOX<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">RM<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">AGE<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">DIS<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">RAD<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">TAX<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">PTRATIO<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">B<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">LSTAT<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th><th class="text-left sortable">MEDV<i aria-hidden="true" role="presentation" class="q-table__sort-icon q-table__sort-icon--left q-icon notranslate material-icons">arrow_upward</i></th></tr></thead><tbody><tr class=""><td class="text-left">0.00632</td><td class="text-left">18</td><td class="text-left">2.31</td><td class="text-left">0</td><td class="text-left">0.538</td><td class="text-left">6.575</td><td class="text-left">65.2</td><td class="text-left">4.09</td><td class="text-left">1</td><td class="text-left">296</td><td class="text-left">15.3</td><td class="text-left">396.9</td><td class="text-left">4.98</td><td class="text-left">24</td></tr><tr class=""><td class="text-left">0.02731</td><td class="text-left">0</td><td class="text-left">7.07</td><td class="text-left">0</td><td class="text-left">0.469</td><td class="text-left">6.421</td><td class="text-left">78.9</td><td class="text-left">4.9671</td><td class="text-left">2</td><td class="text-left">242</td><td class="text-left">17.8</td><td class="text-left">396.9</td><td class="text-left">9.14</td><td class="text-left">21.6</td></tr><tr class=""><td class="text-left">0.02729</td><td class="text-left">0</td><td class="text-left">7.07</td><td class="text-left">0</td><td class="text-left">0.469</td><td class="text-left">7.185</td><td class="text-left">61.1</td><td class="text-left">4.9671</td><td class="text-left">2</td><td class="text-left">242</td><td class="text-left">17.8</td><td class="text-left">392.83</td><td class="text-left">4.03</td><td class="text-left">34.7</td></tr><tr class=""><td class="text-left">0.03237</td><td class="text-left">0</td><td class="text-left">2.18</td><td class="text-left">0</td><td class="text-left">0.458</td><td class="text-left">6.998</td><td class="text-left">45.8</td><td class="text-left">6.0622</td><td class="text-left">3</td><td class="text-left">222</td><td class="text-left">18.7</td><td class="text-left">394.63</td><td class="text-left">2.94</td><td class="text-left">33.4</td></tr><tr class=""><td class="text-left">0.06905</td><td class="text-left">0</td><td class="text-left">2.18</td><td class="text-left">0</td><td class="text-left">0.458</td><td class="text-left">7.147</td><td class="text-left">54.2</td><td class="text-left">6.0622</td><td class="text-left">3</td><td class="text-left">222</td><td class="text-left">18.7</td><td class="text-left">396.9</td><td class="text-left"></td><td class="text-left">36.2</td></tr><tr class=""><td class="text-left">0.02985</td><td class="text-left">0</td><td class="text-left">2.18</td><td class="text-left">0</td><td class="text-left">0.458</td><td class="text-left">6.43</td><td class="text-left">58.7</td><td class="text-left">6.0622</td><td class="text-left">3</td><td class="text-left">222</td><td class="text-left">18.7</td><td class="text-left">394.12</td><td class="text-left">5.21</td><td class="text-left">28.7</td></tr><tr class=""><td class="text-left">0.08829</td><td class="text-left">12.5</td><td class="text-left">7.87</td><td class="text-left"></td><td class="text-left">0.524</td><td class="text-left">6.012</td><td class="text-left">66.6</td><td class="text-left">5.5605</td><td class="text-left">5</td><td class="text-left">311</td><td class="text-left">15.2</td><td class="text-left">395.6</td><td class="text-left">12.43</td><td class="text-left">22.9</td></tr><tr class=""><td class="text-left">0.14455</td><td class="text-left">12.5</td><td class="text-left">7.87</td><td class="text-left">0</td><td class="text-left">0.524</td><td class="text-left">6.172</td><td class="text-left">96.1</td><td class="text-left">5.9505</td><td class="text-left">5</td><td class="text-left">311</td><td class="text-left">15.2</td><td class="text-left">396.9</td><td class="text-left">19.15</td><td class="text-left">27.1</td></tr><tr class=""><td class="text-left">0.21124</td><td class="text-left">12.5</td><td class="text-left">7.87</td><td class="text-left">0</td><td class="text-left">0.524</td><td class="text-left">5.631</td><td class="text-left">100</td><td class="text-left">6.0821</td><td class="text-left">5</td><td class="text-left">311</td><td class="text-left">15.2</td><td class="text-left">386.63</td><td class="text-left">29.93</td><td class="text-left">16.5</td></tr><tr class=""><td class="text-left">0.17004</td><td class="text-left">12.5</td><td class="text-left">7.87</td><td class="text-left"></td><td class="text-left">0.524</td><td class="text-left">6.004</td><td class="text-left">85.9</td><td class="text-left">6.5921</td><td class="text-left">5</td><td class="text-left">311</td><td class="text-left">15.2</td><td class="text-left">386.71</td><td class="text-left">17.1</td><td class="text-left">18.9</td></tr></tbody></table></div><div class="q-table__bottom row items-center justify-end"><div class="q-table__separator col"></div><div class="q-table__control"><span class="q-table__bottom-item">Records per page:</span><label for="f_351166f7-ff77-4a70-8bd3-b268231be653" class="q-field q-validation-component row no-wrap items-start q-table__select inline q-table__bottom-item q-select q-field--auto-height q-select--without-input q-select--without-chips q-select--single q-field--borderless q-field--float q-field--dense"><div class="q-field__inner relative-position col self-stretch"><div tabindex="-1" class="q-field__control relative-position row no-wrap text-grey-8"><div class="q-field__control-container col relative-position row no-wrap q-anchor--skip"><div class="q-field__native row items-center"><span>10</span><div id="f_351166f7-ff77-4a70-8bd3-b268231be653" tabindex="0" role="combobox" aria-multiselectable="false" aria-expanded="false" aria-owns="f_351166f7-ff77-4a70-8bd3-b268231be653_lb" aria-activedescendant="f_351166f7-ff77-4a70-8bd3-b268231be653_-1" class="q-select__focus-target"></div></div></div><div class="q-field__append q-field__marginal row no-wrap items-center q-anchor--skip"><i aria-hidden="true" role="presentation" class="q-select__dropdown-icon q-icon notranslate material-icons">arrow_drop_down</i></div><!----></div></div></label></div><div class="q-table__control"><span class="q-table__bottom-item">1-10 of 506</span><button tabindex="-1" type="button" disabled="disabled" aria-disabled="true" class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--round text-grey-8 disabled q-btn--wrap q-btn--dense"><span class="q-focus-helper"></span><span class="q-btn__wrapper col row q-anchor--skip"><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row"><i aria-hidden="true" role="img" class="q-icon notranslate material-icons">first_page</i></span></span></button><button tabindex="-1" type="button" disabled="disabled" aria-disabled="true" class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--round text-grey-8 disabled q-btn--wrap q-btn--dense"><span class="q-focus-helper"></span><span class="q-btn__wrapper col row q-anchor--skip"><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row"><i aria-hidden="true" role="img" class="q-icon notranslate material-icons">chevron_left</i></span></span></button><button tabindex="0" type="button" class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--round text-grey-8 q-btn--actionable q-focusable q-hoverable q-btn--wrap q-btn--dense"><span class="q-focus-helper"></span><span class="q-btn__wrapper col row q-anchor--skip"><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row"><i aria-hidden="true" role="img" class="q-icon notranslate material-icons">chevron_right</i></span></span></button><button tabindex="0" type="button" class="q-btn q-btn-item non-selectable no-outline q-btn--flat q-btn--round text-grey-8 q-btn--actionable q-focusable q-hoverable q-btn--wrap q-btn--dense"><span class="q-focus-helper"></span><span class="q-btn__wrapper col row q-anchor--skip"><span class="q-btn__content text-center col items-center q-anchor--skip justify-center row"><i aria-hidden="true" role="img" class="q-icon notranslate material-icons">last_page</i></span></span></button></div></div></div>`, 
 ...
 */
    ...
    /* {
        type: "pepe", label: "Pepe", tagName: "PEPE", 
        content: "<pepe>Soy pepe</pepe>", 
        properties: [
            droppable: false,     editable: false,     draggable: true,
            { label: "uno",   name: "uno",    type: "text"          },
            { label: "dos",   name: "dos",    type: "Boolean"           },
            { label: "tres",  name: "tres",   type: "String"            }
          ], 
    }, 
    {
        type: "comp1", label: "Comp 1", tagName: "COMP1", 
        content: "<comp1>Comp 1</comp1>", 
        properties: [
            droppable: false,     editable: false,     draggable: true,
            { label: "uno",   name: "uno",    type: "text"          },
            { label: "dos",   name: "dos",    type: "Boolean"           },
    ...
    {
        type: "comp2", label: "Comp 2", tagName: "COMP2", 
        content: "<comp2>Comp 2</comp2>", 
        properties: [
            droppable: false,     editable: false,     draggable: true,
            { label: "uno",   name: "uno",    type: "text"          },
            { label: "dos",   name: "dos",    type: "Boolean"           },
    ...
    {
        type: "comp3", label: "Comp 3", tagName: "COMP3", 
        content: "<comp3>Comp 3</comp3>", 
        properties: [
            droppable: false,     editable: false,     draggable: true,
            { label: "uno",   name: "uno",    type: "text"          },
            { label: "dos",   name: "dos",    type: "Boolean"           },
