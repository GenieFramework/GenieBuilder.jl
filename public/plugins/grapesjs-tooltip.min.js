    ...
    function (t, e, n) {
      ...
      e.default = function (t) {
        ...
        b &&
          ...
          v &&
            t.on("styleManager:update:target", function (e) {
              var n = t.getSelected();
              if (n) {
                var o = n.getEl();
                n.is(s) &&
                  !n.getTrait(w).getTargetValue() &&
                  e.getSelectors().getFullString().trim() == "." + y &&
                  (o.setAttribute(w, "true"),
                  t.once("styleManager:update:target", function () {
                    o.removeAttribute(w);
                  }));
              }
            });
          ...
          model: a.extend(
            ...
            },
            {
              isComponent: function (t) {
                if (t.hasAttribute && t.hasAttribute(p)) return { type: s };
              },
            }
          ),
          view: i.extend({
