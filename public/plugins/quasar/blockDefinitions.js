    ...
    },
    {
        ...
        editor.BlockManager.add('avatar', { label: 'Avatar', content: '<q-avatar />', media: '<img src="images/icons/components/ui_components/avatar.png" class="blockIcon" />', category: 'Widgets' });
    }    
    ...
    },
    {
        ...
        editor.BlockManager.add('badge', { label: 'Badge', content: '<q-badge />', media: '<img src="images/icons/components/ui_components/badge.png" class="blockIcon" />', category: 'Widgets' });
    }    
    ...
    /* const customblock_quasar_button = editor => {
        editor.DomComponents.addType( "Button", {
          ...
          editor.BlockManager.add( 'Button', { label: 'Button', content: `<q-btn label="Button"/>`, media: `<img src="images/icons/components/ui_components/button.png" class="blockIcon"/>`, category: 'Widgets'   }); 
    }     */
    ...
    },
    {
        ...
        editor.BlockManager.add('item', { label: 'Item', content: '<q-item />', media: '<img src="images/icons/components/ui_components/item.png" class="blockIcon" />', category: 'Widgets' });
    }    
    ...
    },
    {
        ...
        editor.BlockManager.add('list', { label: 'List', content: '<q-list />', media: '<img src="images/icons/components/ui_components/list.png" class="blockIcon" />', category: 'Widgets' });
    }    
    ...
    },
    {
        ...
        editor.BlockManager.add('popup-proxy', { label: 'Popup Proxy', content: '<q-popup-proxy />', media: '<img src="images/icons/components/ui_components/popup-proxy.png" class="blockIcon" />', category: 'Widgets' });
    }    
    ...
    },
    {
        ...
        editor.BlockManager.add('timeline-entry', { label: 'Timeline Entry', content: '<q-timeline-entry />', media: '<img src="images/icons/components/ui_components/timeline-entry.png" class="blockIcon" />', category: 'Widgets' });
    }    
