window.Genie = {};
Genie.Settings = {"webchannels_autosubscribe":true,"server_host":"127.0.0.1","env":"dev","webchannels_eval_command":">eval:","webthreads_js_file":"webthreads.js","webchannels_unsubscribe_channel":"unsubscribe","webthreads_default_route":window.CHANNEL,"webchannels_subscribe_channel":"subscribe","server_port":24838,"webchannels_keepalive_frequency":30000,"base_path":"","webthreads_pull_route":"pull","webchannels_default_route":window.CHANNEL,"webchannels_timeout":1000,"webthreads_push_route":"push","websockets_port":24838};
/*
...
function newSocketConnection(host = Genie.Settings.server_host) {
  return new WebSocket('http:'.replace('http', 'ws') + '//' + host
      + (Genie.WebChannels.port !== undefined ? (':' + Genie.WebChannels.port) : '')
