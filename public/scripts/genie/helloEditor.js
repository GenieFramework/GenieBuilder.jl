...
function initEditor(){
    ...
    new Vue({"el":"#app_panel","mixins":[watcherMixin, reviveMixin],"data":{"name":"John","photo":"https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Lillium_Stamens.jpg/320px-Lillium_Stamens.jpg","surname":"Smith","isready":false,"isprocessing":false,"age":55}});
...
window.parse_payload = function(payload){
  console.log( "parse_payload() helloEditor");
    if (payload.key) {
...
function app_ready() {
  if ((canvasDocument.readyState === "complete" || canvasDocument.readyState === "interactive") && Genie.WebChannels.socket.readyState === 1) {
