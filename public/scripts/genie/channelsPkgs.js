window.CHANNEL = 'UAYICWJTWGRVVHTNJUWEILTDKBEVTBZA';
window.Genie = {};
            Genie.Settings = { "webchannels_autosubscribe": true, 
            "server_host": "0.0.0.0", 
            "env": "prod", 
            "webchannels_eval_command": ">eval:", 
            "webthreads_js_file": "webthreads.js", 
            "webchannels_unsubscribe_channel": "unsubscribe", 
            "webthreads_default_route": "UAYICWJTWGRVVHTNJUWEILTDKBEVTBZA", 
            "webchannels_subscribe_channel": "subscribe", 
            "server_port": 8000, 
            "webchannels_keepalive_frequency": 30000, 
            "base_path": "", 
            "webthreads_pull_route": "pull", 
            "webchannels_default_route": "UAYICWJTWGRVVHTNJUWEILTDKBEVTBZA", 
            ...
            */
            ...
            function newSocketConnection() {
                try {
                    ...
                    return new WebSocket( 'ws://' + Genie.Settings.server_host + ':' + Genie.Settings.websockets_port );
                } catch (e) {
                    console.error(e);
                }
            }
