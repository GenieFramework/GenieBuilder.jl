        ...
        <p class="text-muted credit" style="text-align:center;color:#8d99ae;">Built with
          ...
          <a class="_genie_logo" href="https://genieframework.com" target="_blank" ref="nofollow">Genie</a>
            ...
            discardAiChanges(){
                ...
                let element = requestObject.element;
                element.removeClass("pendingChangesOK pendingChangesError");
            ...
            acceptAiChanges(){
                ...
                if( requestObject ){
                    let element = requestObject.element;
                    element.removeClass("pendingChangesOK pendingChangesError");
                    let originalElement = editor.getSelected();
                    let originalStyle = originalElement.getStyle()
                    let newElement = editor.getSelected().replaceWith(requestObject.aiApiResponse)
                    let newStyle = newElement.getStyle()
                    let mergedStyle = { ...originalStyle, ...newStyle }
                    newElement.setStyle( mergedStyle )
                    // merge the styles, overriding old values with new ones
                    this.aiRequests[this.getSelectedElement.ccid] = null
                    this.selectedElementAiRequest = null;
            ...
            aiSendClicked(){
                ...
                .then( (response)=>{
                    ...
                    if( responseObject.error ){
                        ...
                        requestObject.element.addClass("pendingChangesError")
                        ...
                        requestObject.element.addClass("pendingChangesOK")
