...
function installgb()
  ...
  cmd = `julia --startup-file=no --depwarn=no -e 'using Pkg;Pkg.activate(".");Pkg.instantiate();Pkg.up();
              Pkg.add(url="https://github.com/GenieFramework/GenieBuilder.jl");Pkg.up();
