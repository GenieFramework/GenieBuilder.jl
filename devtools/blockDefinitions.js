        ...
        "options": []
            ...
            view: {
                onRender() {
                    ...
                    const bindTextTraitValue = model.getAttributes()['v-model']
                    $el.empty();
                    $el.append( '<img src="images/icons/components/ui_components/button.png" />' );
                }
            },
        });
        editor.BlockManager.add('button', { label: 'button', content: '<q-button />', media: '<img src="images/icons/components/ui_components/button.png" class="blockIcon" />', category: 'Quasar' });
    }     */
