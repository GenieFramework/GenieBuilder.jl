...
function assets()
  ...
  if ! isfile(joinpath(Genie.config.server_document_root, "app.css"))
    open(joinpath(Genie.config.server_document_root, "app.css"), "w") do io
      write(io,
      """
  ...
  if ! isfile(joinpath(Genie.config.server_document_root, "grapes.css"))
    open(joinpath(Genie.config.server_document_root, "grapes.css"), "w") do io
      write(io,
      """
      /* WARNING!!! */
  ...
  if ! isfile(joinpath(Genie.config.server_document_root, "app.js"))
    open(joinpath(Genie.config.server_document_root, "app.js"), "w") do io
      write(io,
      """
